...
export const CATALOG: WorkflowGroup[] = [
      ...
      },
      {
        ...
        fields: [
          { name: "incident_date", label: "Incident date", kind: "date", required: true },
          {
            ...
            kind: "select",
            required: true,
            options: ["near_miss", "minor", "major", "fatality"],
          },
  ...
  },
  {
    ...
    workflows: [
      ...
      {
        key: "change-archive",
        title: "Archive a terminal change request",
        scope: "none",
        path: (_s, v) => `/api/v1/change-requests/${v["__id"] ?? ""}/archive`,
        fields: [targetId("Change request ID")],
        pathFields: ["__id"],
        submitLabel: "Archive",
      },
      {
        key: "rfi-archive",
        title: "Archive a closed RFI",
        scope: "none",
        path: (_s, v) => `/api/v1/rfis/${v["__id"] ?? ""}/archive`,
        fields: [targetId("RFI ID")],
        pathFields: ["__id"],
        submitLabel: "Archive",
      },
      {
        key: "ncr-archive",
        title: "Archive a closed NCR",
        scope: "none",
        path: (_s, v) => `/api/v1/ncrs/${v["__id"] ?? ""}/archive`,
        fields: [targetId("NCR ID")],
        pathFields: ["__id"],
        submitLabel: "Archive",
      },
      {
        key: "discrepancy-archive",
        title: "Archive a resolved discrepancy",
        scope: "none",
        path: (_s, v) => `/api/v1/discrepancy-cases/${v["__id"] ?? ""}/archive`,
        fields: [targetId("Case ID")],
        pathFields: ["__id"],
        submitLabel: "Archive",
      },
    ],
